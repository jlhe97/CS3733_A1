...
public class MountOlympus  extends Solitaire{
	...
	private void initializeControllers() {
		...
		for(int i = 0; i < pileViews.length; i++){
			...
			pileViews[i].setMouseAdapter(new MountOlympusPileController(this, pileViews[i]));
	...
	private void initializeModel(int seed) {
		...
		updateNumberCardsLeft(79); // there 79 cards left. 104 - 25 = 79
		updateScore(16);           // score starts at 16 bc of aces and deuces.
	}
